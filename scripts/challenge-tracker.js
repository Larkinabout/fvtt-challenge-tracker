...
class ChallengeTracker extends Application {
	...
	static drawForEveryone(totalSuccess, totalFailure, currentSuccess, currentFailure) {
  	...
  	draw(totalSuccess, totalFailure, currentSuccess, currentFailure) {
		...
		context.fillStyle = "rgba(50, 75, 50, 0.5)";
		context.fill();
		context.closePath();
		// Set gradient
		...
		successGradient.addColorStop(0, "rgba(0, 150, 0, 1)");
		successGradient.addColorStop(1, "rgba(0, 130, 0, 1)");
		...
		context.moveTo(halfCanvasSize, halfCanvasSize);
		context.arc(halfCanvasSize, halfCanvasSize, radius / 5 * 3, 0, 2 * Math.PI);
		context.fillStyle = "rgba(75, 50, 50, 0.5)";
		context.fill();
		context.closePath();
		// Set gradient
		...
		failureGradient.addColorStop(0, "rgba(220, 0, 0, 1)"); 
		failureGradient.addColorStop(1, "rgba(150, 0, 0, 1)");
		// Draw current failure arc
		context.beginPath();
		context.moveTo(halfCanvasSize, halfCanvasSize);
		if (this.currentFailure > 0) context.arc(
			halfCanvasSize,
			halfCanvasSize,
		...
		this.contextFrame.restore();
		// Stroke lines
		this.contextFrame.strokeStyle = "rgba(15, 20, 20, 1)";
